...
- [apps/munu-app](./apps/munu-app): Basic munu-app. [README](./apps/munu-app/README.md) | [DEMO/Vercel](https://monorepo-munu-app.vercel.app) | [CHANGELOG](./apps/munu-app/CHANGELOG.md)
...
.
├── apps
│   ├── munu-app                 (Vite app as an example)
│       ├── src/
...
```bash
cd apps/my-app
yarn add @munu/magnificent-poney@'workspace:^'
```
...
```json5
{
  "name": "my-app",
  "dependencies": {
    "@munu/magnificient-poney": "workspace:^",
  },
}
```
...
>   graph dependencies.
> - The **star** in `@munu/magnificent-poney/*` allows you to import subfolders. If you use
...
The packages are now linked to your app, just import them like regular packages: `import { poney } from '@munu/magnificent-poney'`.
