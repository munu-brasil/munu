...
```bash
yarn add @munu/common-locales:"workspace:^"
```
...
```json5
{
  "compilerOptions": {
    "paths": {
      "@munu/common-i18n": ["../../../packages/common-i18n/src/index"],
      "@munu/common-i18n/locales/*": [
...
import type { I18nNamespaces } from "@munu/common-i18n";
