module github.com/munu-brasil/munu/backend
...
require (
	...
	github.com/pindamonhangaba/commandments v0.0.0-20230209032551-d88ac6f2ea02
	github.com/pindamonhangaba/go-sqlfmt/sqlfmt v0.0.0-20220902141526-131db16b877b
